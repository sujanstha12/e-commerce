<footer>
    <div class="container-fluid mt-6 footer1">
        <p class="text-center">We Accept: <i class="bi bi-credit-card"></i> <i class="bi bi-paypal"></i>
            <i class="bi bi-apple"></i> <i class="bi bi-google"></i> <i class="bi bi-shop"></i> <i
