        ...
        <div class="container-first">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <h1 class="discover">{{ $about?->title1 }}<span class="fashion">Fashion</span>{{ $about?->title2 }}</h1>
                    <h5 class="lorem1">{{ $about?->description }}</h5>
                    <div class="row">
                        <div class="col md 3">
        ...
        <div class="row">
            ...
            @if ($feature)
                <div class="col-md-3 text-center mb-4">
                    <i class="{{ $feature->icon }}" style="font-size: 5rem;"></i>
                    <h2 class="product-title">{{ $feature->title }}</h2>
        ...
        <div class="carousel-container">
            @foreach ($products as $product)
                <div class="card">
                    <a
                        href="
 @if (Auth::guard('customer')->user()) {{ route('productDetail', $product) }}
                    @else
                    {{ route('customer.registerPage') }} @endif
                   ">
    ...
    <div class="class container-fluid mt-5 text-center">
        ...
        <div class="product-container">
            ...
            <!-- Product 2 -->
            <div class="product-card">
                <img src="https://bootstrapmade.com/content/demo/eStore/assets/img/product/product-4-variant.webp"
            ...
            <!-- Product 3 -->
            <div class="product-card">
                <img src="https://bootstrapmade.com/content/demo/eStore/assets/img/product/product-7-variant.webp"
            ...
            <!--product 4-->
            <div class="product-card">
                <img src="https://bootstrapmade.com/content/demo/eStore/assets/img/product/product-12-variant.webp"
                    alt="Product 3" class="product-image">
    ...
    <div class="container-fluid mt-4 cn">
    ...
    <div class="container-fluid mt-4 estore">
        <div class="row esto">
            <div class="col-md-3">
                <h3 class="mt-4">eStore</h3>
            ...
            <div class="col-md-3">
                <h4 class="mt-4">Download Our App</h4>
